...
export function buildOracleRoomAgentRequest(room, { turnId, message, messageKind = 'question' } = {}) {
  ...
  return {
    ...
    message: [
      ...
      `Тип реплики: ${messageKind === 'answer' ? 'ответ на вопрос Эзотериума; не считай новым пользовательским вопросом' : messageKind === 'guided' ? 'служебный запуск ведущего расклада' : 'новый вопрос или самостоятельная тема пользователя'}.`,
