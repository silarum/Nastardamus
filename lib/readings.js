        ...
        return [
            { role: 'system', content: system },
            {
                ...
                content: [
                    ...
                    'Дай 5–7 цельных абзацев: точное отражение ситуации, различение фактов и догадок, скрытое противоречие, доступная опора, план из трёх последовательных действий и один вопрос для вечерней рефлексии. Не используй списки и не выдавай символический фон за объективный прогноз.'
                ].filter(Boolean).join(' ')
            }
        ];
    }
