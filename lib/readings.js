...
export function buildReadingMessages(feature, payload) {
    ...
    if (feature === 'compatibility') {
        ...
        return [
            ...
            {
                role: 'user',
                content: `Дай бережное символическое толкование совместимости: ${firstName} (${firstDate}) и ${secondName} (${secondDate}). В 5–7 цельных абзацах без заголовков начни с выразительного образа встречи двух разных ритмов, затем сплети притяжение, возможное напряжение, способ поддерживать диалог, личную границу каждого и один общий практический шаг. Не делай категоричных выводов о будущем отношений. Последний короткий абзац должен оставить сильное послевкусие, а не повторить совет.`
            }
        ];
    }
