...
function baseSystem(feature) {
    const voices = {
        ...
        sports_forecast: 'В этом ответе создай символический образ спортивного события: динамика, переломный момент, пространство неопределённости и то, за чем интересно наблюдать. Не изображай расчёт вероятностей и не подталкивай к ставкам.',
        daily_horoscope: 'В этом ответе держи поэтическую волну и добавь мягкий добрый юмор: одну-две меткие бытовые улыбки без сарказма, насмешки и цирковой интонации. Выбери один свежий образ дня и проведи через него отношения, дела, энергию и небольшое действие без обещания событий.'
    };
    return [
        ...
        return [
            { role: 'system', content: system },
            {
                ...
                content: [
                    ...
                    'В 4–6 цельных абзацах без заголовков опиши образ встречи, возможную смену темпа, ключевой момент, неопределённость исхода и одну деталь, за которой особенно интересно наблюдать.',
                    'Не обещай точный счёт, победу или финансовый результат. Ясно напомни, что это художественное чтение для развлечения, а не основа для ставки.'
                ].join(' ')
            }
        ];
    }
        ...
        return [
            { role: 'system', content: system },
            {
                ...
                content: [
                    ...
                    'Обращайся к человеку по имени один раз, не используй заголовки и каждый день выбирай новую метафору, архетип, бытовой образ и ритм.'
                ].join(' ')
            }
        ];
    }
