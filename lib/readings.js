                ...
                content: [
                    {
                        ...
                        text: [
                            ...
                            'Раздели ответ на: «Что отражает образ», «Что могло усилить тревогу», «Что находится в вашей власти», «Мягкое очищающее действие», «Когда обратиться за реальной поддержкой».',
        ...
        return [
            { role: 'system', content: system },
            {
                ...
                content: [
                    ...
                    'Не обещай событий и не запугивай. Дай: образ дня, отношения, дела и деньги, энергия, одно конкретное действие и короткую фразу-настройку.',
                    'Обращайся к человеку по имени один раз, пиши живо и компактно, не повторяй шаблонные формулировки.'
                ].join(' ')
            }
        ];
    }
