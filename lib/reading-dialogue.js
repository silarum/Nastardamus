...
export const READING_DIALOGUE_AGENT_INSTRUCTIONS = [
  ...
  'После содержательного ответа можно предложить не больше одной связанной практики Nastardamus и одним предложением объяснить, что именно она уточнит. Не предлагай услугу механически, при отказе сразу продолжай без неё.',
