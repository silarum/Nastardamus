...
const DEEPSEEK_SYSTEM_AGENTS = new Set(['support-guide', 'onboarding-guide']);
...
const SYSTEM_AGENTS = {
  'support-guide': {
    ...
    instructions: [
      'Ты — помощник поддержки приложения Nastardamus.',
      'Отвечай по-русски, дружелюбно и кратко.',
      'Помогай пользоваться раскладами, фото-чтениями, дневником, кошельком SILARUM и админ-панелью.',
