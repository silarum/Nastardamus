...
export function append(parent, child) {
  ...
  parent.append(child instanceof Node ? child : document.createTextNode(translateText(String(child))));
}
...
export function h(tag, options = {}, ...children) {
  ...
  Object.entries(attrs).forEach(([key, value]) => {
    ...
    else node.setAttribute(key, ['aria-label', 'placeholder', 'title'].includes(key) ? translateText(value) : String(value));
  });
