...
- 4 модульных экрана;
- 30 отдельных художественных PNG с настоящим прозрачным фоном;
- 1 отдельный полноэкранный космический фон;
- 27 масштабируемых SVG-иконок;
...
Художественные объекты находятся в `assets/art-v2`, фон — в том же каталоге
под именем `cosmic-background.png`, а интерфейсные иконки — в `assets/icons`.
Матрица соответствия четырём исходным экранам и последовательность дальнейшей
сборки находятся в `DESIGN_AUDIT.md`.
