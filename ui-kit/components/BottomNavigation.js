...
export default function BottomNavigation({ active="home", onNavigate } = {}) {
 ...
 return h("nav",{className:"n-bottom-navigation"},
  ...
  item("services","services","Услуги"),
  CenterMagicButton({onClick:()=>onNavigate?.("magic")}),
  item("history","history","История"),
  item("profile","profile","Профиль"),
  h("img",{className:"n-bottom-navigation__divider",attrs:{src:premiumArtUrl("cosmic-footer-divider"),alt:"",draggable:"false"}})
 );
}
