  ...
  if (control === 'page') {
    body = body.replace(
      ...
      `<nav class="admin-tabs admin-sidebar" aria-label="Разделы админ-панели">
        ...
        <details class="admin-nav-group" open><summary>Разделы приложения</summary>
          <button type="button" data-tab="content"><b>✦</b><span>Контент</span></button>
        ...
        <details class="admin-nav-group"><summary>Деньги и рост</summary>
          <button type="button" data-tab="payments"><b>◇</b><span>Платежи</span></button>
